...
let apiHost = ''
switch (host) {
  case 'trumpet-front-dmzdev.openshift.com': // dev
    apiHost = 'http://trumpet-gateway-dmzdev.openshift.com/trumpetBackend'
    break
  case 'trumpet-front-dmzsit.openshift.com': // sit
    apiHost = 'http://trumpet-gateway-dmzsit.openshift.com/trumpetBackend'
    break
  case 'trumpet-front-dmzuat.openshift.com': // uat
    apiHost = 'http://trumpet-gateway-dmzuat.openshift.com/trumpetBackend'
    break
  case 'trumpet-front-dmzprod.openshift.com': // prod
    apiHost = 'http://trumpet-gateway-dmzprod.openshift.com/trumpetBackend'
    break
  default: // local
    apiHost = ''
}
...
export default {
  ...
  pageSizeOptions: ['10', '20', '30', '40', '50'], // 可选的每页显示条数
}
